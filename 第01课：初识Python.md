...
1. 1989年12月：吉多·范罗苏姆决心开发一个新的脚本解释编程，作为 ABC 语言的继承者，并且用它替代 Unix shell 和 C 语言来进行系统管理。由于他本人是 BBC 电视剧 *Monty Python's Flying Circus* 的死忠粉，所以选取了 Python 这个词作为新语言的名字。
